...
export function AppBar({ secondCountdown }) {
    const [timeLeft, setTimeLeft] = useState(secondCountdown);

    useEffect(() => {
        setTimeLeft(secondCountdown);
    }, [secondCountdown]);
        ...
        <div>
            <div className="flex flex-row justify-start pl-3 pt-3">
                ...
                <button type="button" className="rounded-full bg-gray-400 p-2 opacity-70">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="lucide lucide-rotate-ccw"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8" /><path d="M3 3v5h5" /></svg>
                </button>
            </div>
            <div className="flex flex-row fixed left-0 top-0 z-50 justify-end h-8 me-9 ml-96">
                <div className="flex pt-1 w-36 ml-96 mr-2 bg-gray-400 opacity-70 rounded-sm shadow-md">
                    ...
                    <div className="text-right px-2 font-medium">{String(minutes).padStart(2, '0')}:{String(seconds).padStart(2, '0')}</div>
                </div>
                ...
                <div className="flex pt-1 w-48 bg-gray-400 opacity-70 rounded-sm shadow-md">
                    <div className="flex">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" class="pt-1 lucide lucide-circle"><circle cx="15" cy="15" r="9" /></svg>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" class="pt-1 lucide lucide-circle"><circle cx="15" cy="15" r="9" /></svg>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" class="pt-1 lucide lucide-circle"><circle cx="15" cy="15" r="9" /></svg>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" class="pt-1 lucide lucide-circle"><circle cx="15" cy="15" r="9" /></svg>
                    </div>
